...
const INLINE_GLOSSARY: Record<string, GlossaryEntry> = {
  "context window": {
    ...
    definition: "Maximum tokens (input + output) the model can process in one request.",
    unit: "tokens",
  },
  "rate limit": {
    term: "Rate Limit",
    short: "rate_limit",
    definition: "Maximum API usage allowed per time window. Often varies by provider, account tier, and billing.",
    unit: null,
  },
  rpm: {
    term: "RPM",
  ...
  "input tokens": {
    term: "Input Tokens",
    short: "input_price",
    definition: "Tokens sent to the model as input.",
    unit: "$/1M tokens",
  },
  "output tokens": {
    term: "Output Tokens",
    short: "output_price",
    definition: "Tokens generated by the model as response.",
    unit: "$/1M tokens",
  },
